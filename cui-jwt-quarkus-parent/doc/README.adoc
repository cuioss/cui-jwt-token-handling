...
* **link:/Users/oliver/git/cui-llm-rules/standards/cdi-quarkus/[CDI Quarkus Standards]** - Development standards and best practices
...
This extension follows the **link:/Users/oliver/git/cui-llm-rules/standards/cdi-quarkus/[CDI Quarkus Standards]** for:
...
* **Standards**: Follow link:/Users/oliver/git/cui-llm-rules/standards/cdi-quarkus/[CDI Quarkus Standards]
