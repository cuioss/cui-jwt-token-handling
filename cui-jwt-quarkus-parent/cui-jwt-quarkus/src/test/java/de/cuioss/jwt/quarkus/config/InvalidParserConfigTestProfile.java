...
/**
 * Test profile with invalid parser configuration (maxTokenSizeBytes <= 0).
 * <p>
 * This profile is used to test the error handling path where the parser configuration
 * has an invalid maxTokenSizeBytes value.
 */
public class InvalidParserConfigTestProfile implements QuarkusTestProfile {
    ...
    public Map<String, String> getConfigOverrides() {
        ...
        // Global parser configuration with invalid maxTokenSizeBytes
        config.put("cui.jwt.parser.leeway-seconds", "30");
        config.put("cui.jwt.parser.max-token-size-bytes", "0"); // Invalid value
