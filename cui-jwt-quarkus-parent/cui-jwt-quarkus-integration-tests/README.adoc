...
[source,bash]
----
# Run JVM tests only (using integration-tests profile)
./scripts/run-integration-tests.sh

# Run native tests only (using integration-tests and native profiles)
./scripts/run-integration-tests.sh --native --skip-jvm

# Run both JVM and native tests (using integration-tests and native profiles)
./scripts/run-integration-tests.sh --native

# Skip clean build
./scripts/run-integration-tests.sh --no-clean

# Run directly with Maven (JVM tests)
../../mvnw clean verify -Pintegration-tests -pl cui-jwt-quarkus-parent/cui-jwt-quarkus-integration-tests

# Run directly with Maven (native tests)
../../mvnw clean verify -Pintegration-tests,native -pl cui-jwt-quarkus-parent/cui-jwt-quarkus-integration-tests -am
----
