...
_See specification: xref:specification/benchmark.adoc#token-validation-performance[Token Validation Performance]_
...
_See specification: xref:specification/benchmark.adoc#jwks-key-retrieval-performance[JWKS Key Retrieval Performance]_
