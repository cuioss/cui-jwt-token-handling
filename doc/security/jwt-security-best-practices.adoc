...
1. **Use strong, asymmetric algorithms**
   ...
   * *Implementation*: link:../../cui-jwt-validation/src/main/java/de/cuioss/jwt/validation/security/AlgorithmPreferences.java[AlgorithmPreferences.java] automatically rejects HMAC algorithms
...
2. **Explicitly specify allowed algorithms**
   ...
   * *Implementation*: link:../../cui-jwt-validation/src/main/java/de/cuioss/jwt/validation/security/AlgorithmPreferences.java[AlgorithmPreferences.java:53] explicitly rejects "none" and HMAC algorithms
