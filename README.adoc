...
image:https://github.com/cuioss/cui-jwt/actions/workflows/benchmark.yml/badge.svg?branch=main[JMH Benchmarks,link=https://github.com/cuioss/cui-jwt/actions/workflows/benchmark.yml]
